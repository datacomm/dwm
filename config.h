...
static Rule rules[] = {
        ...
        { "Gnome-panel", NULL,    NULL,       1 << 8,       True },
};
...
static const char *volmutecmd[]  = { "amixer", "-q", "set", "Master", "0", NULL };
static const char *screenlockcmd[] = { "xscreensaver-command", "-lock", NULL };


/* XXX: hardcoding XF86XK_AudioLowerVolume, etc. */
static Key keys[] = {
	/* modifier                     key        function        argument */
    { 0,                            0x1008FF13, spawn,         {.v = volupcmd} },
    { 0,                            0x1008FF11, spawn,         {.v = voldncmd} },
    { 0,                            0x1008FF12, spawn,         {.v = volmutecmd} },
    { MODKEY|ControlMask,           XK_Delete, spawn,          {.v = screenlockcmd } },
